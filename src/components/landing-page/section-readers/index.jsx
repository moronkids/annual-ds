        ...
        <div className="container">
          ...
          <ReactPlaceholder showLoadingAnimation ready={ready} customPlaceholder={<Skeleton />}>
            {DataReaders.map((value, index) => (
              <div className="row ds-section__readers-inner align-items-center" key={index}>
                <div className={`col-md ds-section__readers-desc ${value.imagesDirection}`}>
                  <Fade bottom duration={1500}>
                    <div className="ds-section__readers-desc">
                      <p className="ds-section__readers-desc-title">{value.title}</p>
                      <p className="ds-section__readers-desc-content">{value.desc}</p>
                      <p className="ds-section__readers-desc-date">*per Oct 2021</p>
                    </div>
                  </Fade>
                </div>
